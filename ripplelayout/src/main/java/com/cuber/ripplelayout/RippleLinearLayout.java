...
public class RippleLinearLayout extends LinearLayout {
    ...
    public RippleLinearLayout duration(int duration) {
        this.duration = duration;
        return this;
    }

    public RippleLinearLayout interpolator(TimeInterpolator interpolator) {
    ...
    public void startRippleAnimation(final int centerX, final int centerY, int min, int max, boolean expand) {
        ...
        if (expand)
            valueAnimator = ValueAnimator.ofInt(0, max);
        else
